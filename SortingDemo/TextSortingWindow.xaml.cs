    ...
    public partial class TextSortingWindow : Window
    {
        ...
        private async void StartSortButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (words.Length < 1)
                {
                    MessageBox.Show("Должно быть хотя бы одно слово для сортировки!", "Ошибка", MessageBoxButton.OK, MessageBoxImage.Warning);
                    return;
                }
        ...
        private void PlotSortingResults()
        {
            // Создаем коллекцию данных для графика
            var seriesCollection = new SeriesCollection
            {
                new ColumnSeries
                {
                    Title = lastSortingResult.Method,
                    Values = new ChartValues<long> { lastSortingResult.Time }
                }
            };

            // Устанавливаем коллекцию в график
            ...
            Chart.AxisX.Add(new Axis
            {
                ...
                Labels = new[] { lastSortingResult.Method }
            });
            ...
            Chart.AxisY.Add(new Axis
            {
                Title = "Время (мс)",
                MinValue = 0,
                MaxValue = lastSortingResult.Time + 100 // Увеличиваем максимум для наглядности
            });
        }
